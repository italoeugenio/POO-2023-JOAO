 ...
 * Ítalo Cezar Eugênio de Santana (22102126)
 * Jairo Pereira de Sousa Júnior (22101494)
 * Luís Henrique Souza Oliveira dos Santos (UC22101329)
 */

//Aperte o botão "run" para compilar.
public class Clinica_Hospital_MAIN{
    ...
    public static void Escolha(int opcao){
        switch(opcao){
            case 1:
                ...
                System.out.println("Aperta Enter pra continuar...");
